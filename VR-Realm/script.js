...
user.position.set(-4.09,-5.17,8.16);
user.rotation.set(-2.73,-1.83,-2.78);
scene.add( user );
user.add( camera );
...
// floating_tree
let calm = new GLTFLoader();
calm.load('./calm/scene.gltf', (gltf) => {
	Mesh = gltf.scene;
	MeshParent = gltf;
	scene.add(Mesh);
...
audioLoader.load('./audio/focused.mp3', function (buffer) {
